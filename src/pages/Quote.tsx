              ...
              {!file ? (
                ...
                <div className="space-y-3">
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between text-gray-500">
                      <span>Material volume ({analysis.volume.toFixed(1)} cm³)</span>
                      <span>${(analysis.volume * 0.35).toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-gray-500">
                      <span>Material ({material})</span>
                      <span>×{materialFactor.toFixed(1)}</span>
                    </div>
                    <div className="flex justify-between text-gray-500">
                      <span>Infill ({infill}%)</span>
                      <span>×{infillFactor.toFixed(2)}</span>
                    </div>
                    ...
                    {advanced && (
                      <>
                        <div className="flex justify-between text-gray-500">
                          ...
                          <span>×{wallFactor.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between text-gray-500">
                          <span>Layer height ({layerHeight}mm)</span>
                          <span>×{layerFactor.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between text-gray-500">
                          <span>Supports</span>
                          <span>×{supportFactor.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between text-gray-500">
                          <span>Finish</span>
                          <span>×{finishFactor.toFixed(2)}</span>
                        </div>
                      </>
                    )}
                  </div>
