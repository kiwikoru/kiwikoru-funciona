              ...
              {submitted ? (
                <div className="border border-gray-200 rounded-2xl p-12 text-center bg-cream">
                  ...
                  <div className="flex flex-wrap justify-center gap-3">
                    ...
                    <button
                      onClick={() => { setSubmitted(false); setForm({ name: '', company: '', email: '', phone: '', subject: 'General Enquiry', projectType: '', message: '' }); setFiles([]); }}
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input type="text" value={form.company} onChange={e => setForm(f => ({ ...f, company: e.target.value }))} placeholder="Your company (optional)" className={inputClass} />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input type="tel" value={form.phone} onChange={e => setForm(f => ({ ...f, phone: e.target.value }))} placeholder="+64 ..." className={inputClass} />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <select value={form.projectType} onChange={e => setForm(f => ({ ...f, projectType: e.target.value }))} className={inputClass}>
                  ...
                  <div>
                    ...
                    <div className="border border-gray-200 border-dashed rounded-lg p-4">
                        ...
                        <div className="space-y-2 mb-3">
                          {files.map((file, i) => (
                            <div key={i} className="flex items-center justify-between bg-cream rounded-lg px-3 py-2 text-sm">
                              ...
                              <button type="button" onClick={() => removeFile(i)} className="p-1 hover:bg-gray-200 rounded transition-colors shrink-0">
                      ...
                      <button type="button" onClick={() => fileInputRef.current?.click()} className="w-full py-2.5 border border-gray-200 rounded-lg text-sm text-gray-500 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
                        <Upload size={16} /> Attach files (STL, images, PDFs)
                      </button>
                      <input ref={fileInputRef} type="file" multiple accept=".stl,.obj,.3mf,.pdf,.png,.jpg,.jpeg,.step,.stp" className="hidden" onChange={handleFileSelect} />
                  ...
                  <button type="submit" disabled={submitting} className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-gold text-forest-dark font-semibold rounded-lg hover:bg-gold-light transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                    {submitting ? (
            ...
            <div className="space-y-6">
                ...
                <div className="border border-gray-200 rounded-2xl p-6 bg-cream">
                  ...
                  <div className="space-y-4">
                    <a href="mailto:kiwikoru3d@gmail.com" className="flex items-start gap-3 group">
                      <div className="w-10 h-10 bg-forest/5 rounded-lg flex items-center justify-center shrink-0"><Mail size={18} className="text-forest" /></div>
                      <div>
                        <p className="text-sm font-medium text-charcoal group-hover:text-forest transition-colors">kiwikoru3d@gmail.com</p>
                        <p className="text-xs text-gray-400">Email us anytime</p>
                      </div>
                    </a>
                    <a href="tel:+640272602954" className="flex items-start gap-3 group">
                      <div className="w-10 h-10 bg-forest/5 rounded-lg flex items-center justify-center shrink-0"><Phone size={18} className="text-forest" /></div>
                      <div>
                        <p className="text-sm font-medium text-charcoal group-hover:text-forest transition-colors">+64 027 260 2954</p>
                        <p className="text-xs text-gray-400">Mon–Fri, 8am–5pm NZST</p>
                      </div>
                    </a>
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 bg-forest/5 rounded-lg flex items-center justify-center shrink-0"><MapPin size={18} className="text-forest" /></div>
                      <div>
                        <p className="text-sm font-medium text-charcoal">Whangārei, Northland</p>
                        <p className="text-xs text-gray-400">New Zealand</p>
                      </div>
                    </div>
                    <a href="https://wa.me/640272602954?text=Hi%20KiwiKoru%2C%20I%27m%20interested%20in%20your%203D%20printing%20services" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group">
                      <div className="w-10 h-10 bg-[#25D366]/10 rounded-lg flex items-center justify-center shrink-0"><MessageSquare size={18} className="text-[#25D366]" /></div>
                      <div>
                        <p className="text-sm font-medium text-charcoal group-hover:text-[#25D366] transition-colors">WhatsApp</p>
              ...
              <ScrollReveal>
                <div className="border border-gray-200 rounded-2xl p-6 bg-white">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between"><span className="text-gray-500">Monday – Friday</span><span className="font-medium text-charcoal">8:00 AM – 5:00 PM</span></div>
                    <div className="flex justify-between"><span className="text-gray-500">Saturday</span><span className="font-medium text-charcoal">By appointment</span></div>
                    <div className="flex justify-between"><span className="text-gray-500">Sunday</span><span className="text-gray-400">Closed</span></div>
                  </div>
              ...
              <ScrollReveal>
                <div className="border border-gray-200 rounded-2xl p-6 bg-white">
                  ...
                  <Link to="/quote" className="inline-flex items-center gap-2 px-6 py-3 bg-forest text-white font-medium rounded-lg hover:bg-forest-light transition-all w-full justify-center">
